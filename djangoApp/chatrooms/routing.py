...
websocket_urlpatterns = [
    ...
    re_path(r'ws/chat/(?P<room_name>\w+)/createquiz/', client.ChatRoomConsumer.as_asgi()),
    re_path(r'ws/chat/(?P<room_name>\w+)/(?P<task_name>\w+)', client.ChatRoomConsumer.as_asgi()),
    re_path(r'ws/chat/(?P<room_name>\w+)/quiz/(?P<quiz_name>\w+)', client.ChatRoomConsumer.as_asgi()),
